    ...
    <div className="min-h-screen bg-white text-black">
      <div className="relative z-10 min-h-screen">
        <header className="w-full max-w-6xl mx-auto mb-12 relative z-10">
          ...
          <p className="text-black/80 text-center md:text-left mt-4 text-lg max-w-2xl leading-relaxed">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6 max-w-4xl">
            <div className="bg-white/10 backdrop-blur-lg p-6 rounded-lg border border-white/20 shadow-xl">
              ...
              <h3 className="text-lg font-semibold text-black">High Precision</h3>
              <p className="text-sm text-black/70 mt-2">Advanced AI algorithms ensure accurate emotion detection in real-time.</p>
            </div>

            <div className="bg-white/10 backdrop-blur-lg p-6 rounded-lg border border-white/20 shadow-xl">
              <Info className="w-5 h-5 text-purple-300 mb-3" />
              <h3 className="text-lg font-semibold text-black">Privacy First</h3>
              <p className="text-sm text-black/70 mt-2">All processing happens locally in your browser. Your data stays with you.</p>
            </div>

            <div className="bg-white/10 backdrop-blur-lg p-6 rounded-lg border border-white/20 shadow-xl">
              <Sparkle className="w-5 h-5 text-purple-300 mb-3" />
              <h3 className="text-lg font-semibold text-black">Dual Input</h3>
              <p className="text-sm text-black/70 mt-2">Choose between real-time webcam analysis or image upload.</p>
            </div>
          </div>
        </header>
        ...
        <main className="w-full max-w-6xl mx-auto relative z-10">
          ...
          <section className="mt-12 bg-white/10 backdrop-blur-lg p-8 rounded-lg max-w-4xl mx-auto border border-white/20">
            <h2 className="text-2xl font-semibold mb-8 text-black text-center">How It Works</h2>
            <div className="grid gap-8">
              <div className="flex flex-col md:flex-row gap-6 items-center">
                ...
                <div className="w-full md:w-1/2 flex items-start gap-3">
                  ...
                  <p className="text-black/70">Choose your preferred input method - webcam for real-time analysis or upload an image</p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row-reverse gap-6 items-center">
                ...
                <div className="w-full md:w-1/2 flex items-start gap-3">
                  ...
                  <p className="text-black/70">Our AI model processes the input and detects facial features with high precision</p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center">
                ...
                <div className="w-full md:w-1/2 flex items-start gap-3">
                  ...
                  <p className="text-black/70">Advanced algorithms analyze the detected features to determine emotional states</p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row-reverse gap-6 items-center">
                ...
                <div className="w-full md:w-1/2 flex items-start gap-3">
                  ...
                  <p className="text-black/70">View detailed results showing primary and secondary emotions with confidence scores</p>
                </div>
              </div>
            </div>

            <p className="mt-8 text-sm text-black/70 bg-purple-950/20 p-4 rounded-lg border border-white/20">
        ...
        <footer className="w-full max-w-6xl mx-auto mt-12 text-center text-sm text-black/80 relative z-10">
